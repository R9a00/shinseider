    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">運営者のコメント</h3>
          <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
            <p>
              補助金というものは、税金で構成される予算から賄われるため、不正受給を避けるための非常に煩雑な仕組みのもと運用されています。こういうものは大抵「知っていれば簡単」ですが、補助金の申請なんて毎月のことではないし、毎回忘れた状態からスタートせざるを得ない。
            </p>
            <p>
              必要なのも分かるが、毎回毎回、めんどくさい。なんらかの意味があるのだろけど、ややこしい。これっておそらく交付元も求めているものではないのでしょうが、そんなことを言っていても補助金はもらえません。
            </p>
            <p>
              そこで、補助金申請の失敗で一番多いと思われる「抜け漏れ」をなくすこと、そして申請を効率的に実現することに焦点を当てたサービス「シンセイダー」を作りました。これを使って補助金申請の煩わしさ、ややこしさを少しでも緩和できればと思っています。
            </p>
            <p>
              2025/8現在は、細かい申請書、必要な書類の作成まで助けることはできないベータ版ですが、もっと拡張していくことで、ほぼここで完結するようにしていきたいと考えています。現時点では社会貢献と使命感がモチベーションの個人プロダクトなので更新頻度は低いかもしれませんが、不具合や希望があれば、ご指摘・ご連絡をお待ちしています。
            </p>
            <p className="text-gray-800 font-medium">
              皆さんの補助金作成の効率アップに少しでも貢献できれば幸いです。
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl p-8 text-white">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              アトツギ甲子園地域アンバサダー（当サイト運営者）がみなさんの相談を常時受け付けています。<br />
              自分のエリアのアンバサダーを紹介して欲しい等のご要望にもお応えしますので、お問い合わせフォームまたは各SNSのDMからご連絡をお願いします。
            </p>
          </div>
