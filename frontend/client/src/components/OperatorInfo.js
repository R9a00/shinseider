      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
          ...
          <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
            <p>
              補助金というものは、税金で構成される予算から賄われるものであることから、不正受給を避けるための、非常に煩雑な仕組みが運用されています。こういうものは大抵「知っていれば簡単」なものですが、補助金の申請なんて毎月のことではないし、毎回忘れた状態からスタートせざるを得ない、例えるなら確定申告のようなものです。
            </p>
            <p>
              必要なのも分かるが、毎回毎回、めんどくさい。なんらかの意味があるのだろけど、ややこしい。これっておそらく交付元も求めているものではないと思っています。なんなら不正に使わず、無限に財源があれば全員にあげたいから成果を出してくれと思っているのではないでしょうか。
            </p>
            <p>
              ですがそんなことを言っていても無意味です。そこで、補助金申請の失敗で一番多いと思われる「抜け漏れ」をなくすこと、そして申請を効率的に実現することに焦点を当てたサービス「シンセイダー」を作りました。
            </p>
            <p>
              2025/8現在は、細かい申請書、必要なショルの作成まで助けることはできないベータ版ですが、もっと拡張していくことで、ほぼここで完結するようにしていきたいと考えています。現時点では社会貢献と使命感がモチベーションの個人プロダクトなので更新頻度は低いかもしれませんが、不具合や希望があれば、ご指摘・ご連絡をお待ちしています。
            </p>
