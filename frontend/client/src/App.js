      ...
      <header className="sticky top-0 z-40 border-b border-gray-100 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70" aria-label="グローバルヘッダー">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-6">
          ...
          <nav className="hidden items-center gap-6 md:flex" aria-label="メインナビゲーション">
            ...
            <a href="#atotsugi" className="text-sm font-medium text-gray-700 hover:text-gray-900">アトツギの方へ</a>
        ...
        {mobileOpen && (
          <div id="mobile-nav" className="border-t border-gray-100 bg-white md:hidden">
            <div className="mx-auto flex max-w-7xl flex-col gap-1 px-4 py-3">
              ...
              <a href="#atotsugi" className="rounded-md px-3 py-2 text-base font-medium hover:bg-gray-50">アトツギの方へ</a>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <Link to="/subsidy-selection?focus=atotsugi" className="inline-flex items-center justify-center w-full rounded-lg bg-red-600 px-4 py-3 text-sm font-semibold text-white shadow hover:bg-red-500 transition-all duration-200">
